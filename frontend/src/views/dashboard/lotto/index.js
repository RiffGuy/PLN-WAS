...
import customerSatisficationChart from './chart/sales-customer-satisfication-chart';
import accountChartProps from './chart/sales-account-chart';
import supportChartProps from './chart/sales-support-chart';
import supportChart1Props from './chart/sales-support-chart1';
...
const lotto = () => (
    <Row>
        <Col md={12} xl={6}>
            <Card className="flat-card">
                <div className="row-table">
                    <Card.Body className="col-sm-6 br">
                        <FlatCard params={{ title: '1등 확률', iconClass: 'text-primary mb-1', icon: 'language', value: '1 / 8,145,060' }} />
                    </Card.Body>
                    <Card.Body className="col-sm-6 d-none d-md-table-cell d-lg-table-cell d-xl-table-cell card-body br">
                        <FlatCard params={{ title: '2등 확률', iconClass: 'text-primary mb-1', icon: 'language', value: '1 / 8,145,060' }} />
                    </Card.Body>
                </div>
                <div className="row-table">
                    <Card.Body className="col-sm-6 card-bod">
                        <FlatCard params={{ title: '3등 확률', iconClass: 'text-primary mb-1', icon: 'language', value: '1 / 203,626.5' }} />
                    </Card.Body>
                    <Card.Body className="col-sm-6 br">
                        <FlatCard params={{ title: '4등', iconClass: 'text-primary mb-1', icon: 'language', value: '1 / 9,933' }} />
                    </Card.Body>
                    <Card.Body className="col-sm-6 d-none d-md-table-cell d-lg-table-cell d-xl-table-cell card-body br">
                        <FlatCard params={{ title: '5등', iconClass: 'text-primary mb-1', icon: 'language', value: '1 / 709.5' }} />
                    </Card.Body>
                </div>
            </Card>
            {/*<Row>*/}
            ...
            {/*                </Row>*/}
            {/*            </Card.Footer>*/}
            {/*            <Chart type="bar" {...supportChart1Props} />*/}
            {/*        </Card>*/}
            {/*    </Col>*/}
            {/*</Row>*/}
        </Col>
        ...
        {/*                <Col>*/}
        {/*                    <Chart type="pie" {...customerSatisficationChart} />*/}
        {/*                </Col>*/}
        {/*            </Row>*/}
        {/*        </Card.Body>*/}
        {/*    </Card>*/}
